    ...
    <div className="min-h-screen bg-[#F1F5F9]">
      ...
      >
        ...
        <main className="p-6">
          ...
          <div className="mb-6">
            <h1 className="text-2xl font-semibold text-gray-900">Análise de Dados</h1>
            <p className="text-gray-500 mt-1">Analise dados com IA</p>
          </div>

          <div className="bg-white rounded-lg border border-gray-200 p-6">
            <p className="text-gray-500 text-center py-12">Análise de dados</p>
          </div>
        </main>
      </div>
    </div>
