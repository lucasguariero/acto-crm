...
export default function FaturamentoNotasPage() {
      ...
      >
        ...
        <main className="p-6">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-500 mt-1">Gerencie notas fiscais</p>
          </div>

          <div className="bg-white rounded-lg border border-gray-200 p-6">
            <p className="text-gray-500 text-center py-12">Notas fiscais</p>
          </div>
        </main>
      </div>
    </div>
